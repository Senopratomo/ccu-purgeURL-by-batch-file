...
public class Invalidate {
    ...
    public Invalidate(String edgerc, String network, String body) throws IOException, ParseException {
        //Parse JSON body
        boolean isListFile;
        ...
        if(network.equalsIgnoreCase("staging")) {
            String INVALIDATE_URL_STAG = "/ccu/v3/invalidate/url/staging";
            ...
            String INVALIDATE_URL_PROD = "/ccu/v3/invalidate/url/production";
